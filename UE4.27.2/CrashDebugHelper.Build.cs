...
public class CrashDebugHelper : ModuleRules
{
	public CrashDebugHelper( ReadOnlyTargetRules Target ) : base(Target)
	{
		...
		// ETERNAL BEGIN
		if( PublicUEBuildPlatform.IsPlatformRegistered( UnrealTargetPlatform.Mac ) )
		{
			PrivateIncludePaths.Add( "Developer/CrashDebugHelper/Private/Mac" );
		}

		if( PublicUEBuildPlatform.IsPlatformRegistered( UnrealTargetPlatform.IOS ) )
		{
			PrivateIncludePaths.Add( "Developer/CrashDebugHelper/Private/IOS" );
		}
		// ETERNAL END
